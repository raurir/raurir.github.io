...
function positionPoint(index, total) {
	...
	var methods = [[frand(sizeX), frand(sizeY)], // original random
	...
	// 3 grid
	[(x - settings.pointBias / 2 + frand(settings.pointBias)) * blockX, (y - settings.pointBias / 2 + frand(settings.pointBias)) * blockY]];
