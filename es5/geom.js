...
var intersectionAnywhere = function intersectionAnywhere(p0, p1, p2, p3) {
	...
	if (isLine1Vertical && isLine2Vertical) {
		...
		if (line0.m - line1.m == 0) {
			// console.log("intersectionAnywhere: no intercept");
			return null;
		} else {
			intersectionX = (line1.c - line0.c) / (line0.m - line1.m);
			intersectionY = line0.m * intersectionX + line0.c;
			// console.log("intersectionAnywhere:", intersection_X, intersection_Y);
		}
	}
	// if (intersectionY == 0) {
	//   console.log("intersectionY IS 0!", isLine1Vertical, isLine2Vertical, line0, line1);
	//   console.log("intersectionY p0 p1", p0, p1);
	//   console.log("intersectionY p2 p3", p2, p3);
	// }
...
var insetPoints = function insetPoints(points, offset) {
	...
	for (var i = 0, il = points.length; i < il; i++) {
		...
		// console.log(i, pp0, pp1);
		parallels.push(parallelPoints(pp0, pp1, offset));
	}
	// console.log("parallels.length", parallels.length);
	for (i = 0, il = parallels.length; i < il; i++) {
		...
		if (inside) {
			...
			// console.warn("geom.insetPoints fail, not inside");
