...
var experiment_template_babel =
	function experiment_template_babel() {
		var settings = {};
		...
		var render = function render() {
			...
			while (points.length < 4) {
				points.push({
					x: rand.getNumber(0.1, 0.9),
					y: rand.getNumber(0.1, 0.9),
				});
			}

			var intersects = geom.intersectionBetweenPoints.apply(
				null,
				points,
			);
			if (intersects) {
