...
var colours = function colours(rand, version) {
	...
	function showColours() {
		...
		for (var i = 0; i < palettes.length; i++) {
			...
			var p = showPalette();
			var darkest = currentPalette.map(function (colour, index) {
				return {
					colour: colour,
	...
	function addPreviewCSS() {
		var css = [".palette {", "  clear: both;", "  height: 50px;", " margin-bottom: 20px", "}", ".colour {", "  width: 100px;", "  height: 50px;", "  float: left;", "  text-align: center;", "  font-size: 10px;", "  line-height: 50px;", "}"].join("");
