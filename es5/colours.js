...
var colours = function () {
	...
	var random;if (rand) {
		...
		random = Math.random;con.warn("!!!! colours is using native random");
	}
	var paletteIndex = -1,
	    currentPalette = null;
	var colourIndex = 0;
