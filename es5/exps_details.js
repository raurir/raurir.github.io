...
define("exps_details", function () {
  ...
  ["additive"], ["aegean_sun"], ["alien"], ["anemone_three", "THREE"], ["any_image_url"], ["attractor"], ["ball_and_chain", "THREE"], ["bill_stevens", "THREE", "TweenMax"], ["bezier_flow"], ["box", "maze"], ["circle_packing"], ["circle_packing_zoom_loop"], ["circle_sectors"], ["codevember", "THREE", "TweenMax"], ["corona_sine"], ["creature"], //, "creature_creator"], //, "creature_creator/creature_creator", "creature_creator/human"],
  ...
  ["meandering_polygons"], ["mining_branches"], ["molecular_three", "THREE"], ["nested_rotating_polygon", "ease"], ["oscillate_curtain"], ["oscillator"], ["overflow"], ["pattern_check", "css:pattern_check"], ["pattern_circles"], ["perlin_grid", "THREE", "TweenMax"], ["perlin_leaves"], ["perlin_noise"], ["polyhedra", "3d"], // 3d is not moduled!
  ...
  return {
    ...
    getFeature: function getFeature(key) {
      var features = {
        "codevember": [{ "day": 1, "title": details.cube_pixelator.title, "link": "cube_pixelator" }, { "day": 2, "title": details.synth_ambient.title, "link": "synth_ambient" }, { "day": 3, "title": "Refactored Experiments" }, // not actually an experiment
